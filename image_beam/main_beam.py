...
def main():
    ...
    shutil.copy('./scenario23_img_beam_train.csv', pwd)
    shutil.copy('./scenario23_img_beam_val.csv', pwd)
    shutil.copy('./scenario23_img_beam_test.csv', pwd)
    ...
    train_dir = 'scenario23_img_beam_train.csv'
    val_dir = 'scenario23_img_beam_val.csv'
